...
import { ProductManagement } from "../../../../utils/Constant";
import {
  Card,
  CardBody,
  Col,
...
import ProductsTab from "./ProductsTable/ProductsTab";
...
function ProductModule() {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={ProductManagement} parent={ProductManagement} />
      <Container fluid>
        <Card>
          <CardBody>
            <Row>
                  ...
                  {({ setFieldValue, values }) => (
                    <Form className="theme-form">
                      <Row className="g-2">
                        <Col md="12">
                          <FormGroup>
                            <Label check>Filter By Metal</Label>
              ...
              <Col sm="12">
                <ProductsTab selectedStatus={selectedStatus} />
              </Col>
            </Row>
          </CardBody>
        </Card>
