...
import PurTab from "./PurTable/PurTab";
...
function PurModule() {
  ...
  return (
    <>
      <Breadcrumbs mainTitle="Digital Purchases" parent="Digital Purchases" />
      <Container fluid>
        <Card>
          <CardBody>
            <Row>
              ...
              <Col sm="12">
                <PurTab selectedStatus={selectedStatus} />
              </Col>
            </Row>
          </CardBody>
        </Card>
